...
Этот Telegram-бот позволяет искать фильмы и сериалы, а также добавлять их в избранное. Бот использует два источника данных для поиска: LordSerial и GoodFilms.
